        ...
        <div class="row" style="">
			<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 datapanel" style="">
				<h3 class="header lighter blue">
					Proses Perizinan IMP Jembatan
					<small>Penerimaan Perizinan IMP Jembatan</small>
				</h3>
				<h4>Data Pemohon :</h4>
...
<div class="row" style="background-color:rgb(239, 243, 248); padding-top: 8px; padding-left:5px; padding-right: 5px; padding-bottom: 10px">
    <div class="col-xs-12 col-sm-12">
		<div class="row" style="">
                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 datapanel" style="">
                        <h3>Tanggal Penerbitan Izin:</h3>
                        <div class="edit-group" style="">
                            <div class="input-group">
                                <input class="form-control date-picker" id="tanggal_penerbitan" name="tanggal_penerbitan" data-date-format="dd-mm-yyyy" type="text" >
                                <span class="input-group-addon">
                        ...
                        <div class="edit-group" style="">
                            ...
                            <input type="text" class="form-control crud-edit" placeholder="" 
                                   name="alamat_penerima" id="alamat_penerima"
                                   style="" value="" />
                        </div>
                        <div class="edit-group" style="">
                            <label for="penggunaan">Nomor Telepon</label>
                            <input type="text" class="form-control crud-edit" placeholder="" 
                                   name="nomor_telepon_penerima" id="nomor_telepon_penerima"
                                   style="" value="" />
                        </div>
                    </div>
		</div>	
