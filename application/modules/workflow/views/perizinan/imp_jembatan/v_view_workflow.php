			...
			<div class="col-sm-12 col-md-6 col-lg-6 datapanel" style="">
				...
				<div class="edit-group" style="">
					...
					<span class="name">
						...
						<input type="text" name="luas_tanah" id="luas_tanah" onKeyPress="return numbersonly (this, event)" disabled/>
					</span>
					<span class="m2">
			...
			<div class="col-sm-12 col-md-6 col-lg-6 datapanel" style="">
				...
				<div class="row" style="">
					<div class="col-sm-6 col-md-6 col-lg-6 datapanel" style="">
						<span class="name">
							<label for=luas_tanah>Luas Tanah</label>
							<input type="text" name="luas_tanah" id="luas_tanah" class="duplicate-field" onKeyPress="return numbersonly (this, event)" disabled/>
						</span>
						<span class="m2">
							<label for=m2>m<sup>2</sup></label>
						</span>
