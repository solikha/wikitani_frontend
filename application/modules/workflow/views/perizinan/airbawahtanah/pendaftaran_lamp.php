 ...
 */
?>
<div style="background-color:rgb(239, 243, 248); padding-top: 8px; padding-left:5px; padding-right: 5px; padding-bottom: 10px">
    <div class="row">    
    ...
    <div class="dz-default dz-message">
        <span>
            <span class="bigger-150 bolder">
                <i class="ace-icon fa fa-caret-right red"></i> Drop files</span>
            to upload 				
...
<div class="row" style="margin-left:0px">
    <div class="pull-left command-container" >
        <button type="button" id="btn_action_next" class="btn_submit btn btn-info btn-sm" 
            data-action="previous" data-form="edit-form" style="margin-top:20px;">Prev</button>
