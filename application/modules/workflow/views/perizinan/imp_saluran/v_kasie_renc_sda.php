        ...
        <div class="row" style="">
			<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 datapanel" style="">
				<h3 class="header lighter blue">
					Proses Perizinan IMP Saluran
					<small>Disposisi Kepala Seksi Perencanaan Sumber Daya Air</small>
				</h3>
				<h4>Data Pemohon :</h4>
...
<div class="row" style="background-color:rgb(239, 243, 248); padding-top: 8px; padding-left:5px; padding-right: 5px; padding-bottom: 10px">
    <div class="col-xs-12 col-sm-12">
		<div class="row" style="">
			<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 datapanel" style="">
				<div class="edit-group" style="">
					<label for="penggunaan">Didisposisikan Kepada</label>
					<input type="text" class="form-control crud-edit" placeholder="" 
						name="disposisi_kepada" id="disposisi_kepada"
						style="" value="" disabled="disabled"/>
				</div>
			</div>
		</div>	                                                                
...
OnReadyArray.push(function(){
    console.log('role');
    console.log(document.forms.namedItem("edit-form").elements['next_roledesc'].value);
    nextrole = document.forms.namedItem("edit-form").elements['next_roledesc'].value;
    $('#disposisi_kepada').val(nextrole);
