...
<div class="col-xs-12">
    ...
    <div class="page-header">
        <h1>Quotation For Customer Send Email</h1>
    </div>
    <style type="text/css">
        input[name=to] {
            pointer-events:none;
    ...
    <form action="<?php echo base_url(); ?>index.php/workflow/send_email" method="post">
        <div class="row" style="background-color:rgb(239, 243, 248); padding-top: 8px; padding-left:5px; padding-right: 5px; padding-bottom: 10px">
            <div class="col-xs-12 col-sm-12">
                <div class="row">
                    <p style="font-size: 20px">Apakah anda yakin mengirim file data Quotation For Customer kepada <?php echo $to; ?> ?</p>
        ...
        <div class="row">
            <div class="pull-left command-container">
                <a class="btn btn-default btn-sm" style="margin-top:20px;" href="quot_c?quotc_id=<?php echo $id; ?>">Cancel</a>
