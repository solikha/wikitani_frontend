				...
				<div class="col-sm-8">
							<form action="" method="post">
								...
								<div class="widget-box">
										...
										<h5 class="widget-title smaller">Rating Artikel&nbsp;</h5>
										...
										<div class="widget-body">
											<div class="widget-main padding-6">
												<center><h1 style="color:yellow;"><?php echo $rate; ?></h1></center>
											</div>
										</div>										
								</div>								
								</div>
								...
								<div class="widget-box">
										<div class="widget-header">
										<h5 class="widget-title smaller">Gambar&nbsp;</h5>
							    ...
							    <div class="widget-box">
										<div class="widget-header">
										<h5 class="widget-title smaller">Video Tentang &nbsp;</h5>
