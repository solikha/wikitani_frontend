                                        ...
                                        <div class="widget-main">
                                            ...
                                            if ($passwordcek != NULL) {
                                                ...
                                                <fieldset>
                                                    ...
                                                    <label class="block clearfix">
                                                        <span class="col-sm-4 right register-label" for="form-field-select-1" style="color: white;">Repeat Passsword</span>
                                                        <span class="col-sm-8 block ">
...
<script>
    ...
    $("#form_pass").submit(function (event) {
        ...
        console.log(vdata);
        console.log(data);
        var ajaxurl = '<?php echo $mainurl; ?>login/spasswordNew';
        Manggu.loadAjax({
            type: 'POST',
            url: ajaxurl,
            data: data,
