...
$function = new print_cancelation();
?>
<!DOCTYPE html>
<html>
    <head>
        ...
        <div class="page1">
            ...
            <div style="<?php echo $padding_left;?>">
                <table rotate="-90" style="width: 70mm;font-size:9pt;">
                    ...
                    <tr>
                        <td>APPROVED CANCELLATION OF AMENDMENT<br>ON PAGE: 4(FOUR)<br><br><br><br></td>
                    </tr>
                    <tr>
                        <td style="text-align: right;"><?php echo $function->getdata("nama_tempat", $datalayanan) . ', ' . $function->getdata("tanggal_print", $datalayanan); ?><br>FOR THE AMBASSADOR,</td>
                    </tr>
                    <?php } ?>
                </table>
            </div>
