		...
		<table class="container">
			<tr>
				...
				<td style="padding-left:0px;" class="td-container">
					<table class="content" style="padding:0.5cm; padding-right:0.45cm; border-style:none;">
						<tr>
							...
							<td style="width:8.7cm; height:13.6cm; border-style:none;" class="td-content">
								<table class="sub-content">
									<tr>
										<td class="td-sub-content">
											<b>AMENDMENT:</b> <br/>
											THE BEARER OF THIS PASSPORT IS<br/>
											WIFE / WIDOWED / DIVORCED OF :<br/><br/>
											<b><?php echo strtoupper(getArrayDef($datalayanan,"pasangan_nama")); ?></b><br/>
										</td>
										</td>
									</tr>
								</table>
								...
								<table  class="sub-content">
									<tr>
										<td class="td-sub-content" style="text-align:center;">
										    <br/>
											<?php echo strtoupper(getArrayDef($data_pencetakan,"kota"));?>,&nbsp;<?php echo  strtoupper(getArrayDef($datalayanan,"pbaru_tgl_cetak"));?><br/>
											FOR THE AMBASSADOR
										</td>
									</tr>
								</table>
