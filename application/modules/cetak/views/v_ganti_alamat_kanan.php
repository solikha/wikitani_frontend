							...
							<td style="width:8.7cm; height:13.6cm; border-style:none;" class="td-content">
								<table class="sub-content">
									<tr>
										<td class="td-sub-content">
											<b>AMENDMENT:</b><br/>
											DOMICILE OF BEARER OF THIS PASSPORT<br/>
											IS AMENDED AND TO BE WRITTEN :<br/>
										</td>
									</tr>
								</table>
								<table  class="sub-content">
									<tr>
										<td class="td-sub-content">
											<b><?php echo strtoupper(getArrayDef($datalayanan,"aluar_alamat"));  ?></b><br/>
											<b><?php echo strtoupper(getArrayDef($datalayanan,"aluar_kota"));  ?></b>
										</td>
									</tr>
								</table>
								<table  class="sub-content">
