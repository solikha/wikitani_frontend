        ...
        <div class="page1">
            <div style="padding: 12mm;">
                ...
                <div align="justify" style="font-size:12pt;">
                    <b>Pada hari ini <?php echo $function->getdata($dataakte_lahir, 'tanggal_cetak_nama_hari') ?>,tanggal <?php echo $function->getdata($dataakte_lahir, 'tanggal_cetak_hr') ?> bulan <?php echo $function->getdata($dataakte_lahir, 'tanggal_cetak_bln') ?> tahun <?php echo $function->getdata($dataakte_lahir, 'tanggal_cetak_thn') ?> telah terdaftar dalam daftar pelaporan tentang kelahiran Warga Negara Indonesia yang berdasarkan kepada catatan Akte Kelahiran <?php echo $function->getdata($dataakte_lahir, 'tpt_keluar_akte') ?> No.<?php echo $function->getdata($dataakte_lahir, 'no_tpt_keluar_akte') ?> tertanggal <?php echo $function->getdata($dataakte_lahir, 'tgl_keluar_akte_hr') ?> <?php echo $function->getdata($dataakte_lahir, 'tgl_keluar_akte_bln') ?> <?php echo $function->getdata($dataakte_lahir, 'tgl_keluar_akte_thn') ?>.
                        <br>
                        <br>
                        Bahwa di <?php echo $function->getdata($dataakte_lahir, 'tempat_lahir') ?> pada hari <?php echo $function->getdata($dataakte_lahir, 'tgl_lahir_nama_hari') ?>,tanggal <?php echo $function->getdata($dataakte_lahir, 'tgl_lahir_hr') ?> bulan <?php echo $function->getdata($dataakte_lahir, 'tgl_lahir_bln') ?> tahun <?php echo $function->getdata($dataakte_lahir, 'tgl_lahir_thn') ?> telah lahir sorang anak bernama;</b>
                </div>
                <br>
                <div style="text-align: center;font-size:15pt;"><b><?php echo $function->getdata($dataakte_lahir, 'nama') ?></b></div>
                <br>
                <div align="justify" style="font-size:12pt;">
                    <b>anak <?php echo $function->getdata($dataakte_lahir, 'jenis_kelamin_anak') ?> dari pasangan,
                        <br>
                        <br>
                        Suami;
                        <br>
                        <?php echo $function->getdata($dataakte_lahir, 'nama_ayah') ?> ,seorang warga negara Indonesia.
                        <br>
                        <br>
                        Istri;
                        <br>
                        <?php echo $function->getdata($dataakte_lahir, 'nama_ibu') ?> ,seorang warga negara Indonesia.
                    </b>
                </div>
                <br>
