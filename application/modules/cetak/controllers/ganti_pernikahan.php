...
class ganti_pernikahan extends Print_Controller {
        ...
        if (isset($_GET['lyn_id'])){
           ...
           $data['data_pencetakan'] = array("kota" => $kotakbri, "tanggal_cetak" => "2005-05-05");
            if ($position == "kiri") {
                ...
                $html = $this->load->view("v_ganti_pernikahan_kiri", $data, true);
            } elseif ($position == "kanan") {
                $html = $this->load->view("v_ganti_pernikahan_kanan", $data, true);
            } else {
           ...
           // $pdfFilePath = "the_pdf_output.pdf";
			$pdfFilePath = "Amandemen Ganti Nama Menikah ".getArrayDef($datalayanan,'pemohon').".pdf";
            $pdf->WriteHTML($html);
