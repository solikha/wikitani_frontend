...
class ganti_perceraian extends Print_Controller {
        ...
        if (isset($_GET['lyn_id'])){
           ...
           $data['data_pencetakan'] = array("kota" => $kotakbri, "tanggal_cetak" => "2005-05-05");
            if ($position == "kiri") {
                ...
                $html = $this->load->view("v_ganti_perceraian_kiri", $data, true);
            } elseif ($position == "kanan") {
                $html = $this->load->view("v_ganti_perceraian_kanan", $data, true);
            } else {
           ...
           // $pdfFilePath = "the_pdf_output.pdf";
			$pdfFilePath = "Amandemen Ganti Nama Cerai ".getArrayDef($datalayanan,'pemohon').".pdf";
            $pdf->WriteHTML($html);
