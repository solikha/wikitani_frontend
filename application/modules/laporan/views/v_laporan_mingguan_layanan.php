    ...
    <body>
        ...
        <table style="width:100%;">
            ...
            <tr>
                <td colspan="3" align="center" >
                    <br/>
                    <br/>
                    <span style="font-size:14px; font-weight:900; letter-spacing: 0.8px">LAPORAN MINGGUAN BIDANG IMIGRASI KBRI</span><br>
                    <span style="font-size:12px; font-weight:700; letter-spacing: 2.4px">Bulan <?php echo $bulan . " " . $tahun; ?> </span><br>
                </td>
            </tr>
        </table>
        ...
        <div style="padding-top: 8px; padding-left:5px; padding-right: 5px; padding-bottom: 10px  " class="row">
            ...
            <table class="data">
                <thead>
                    <tr>
                        <th style="font-size:10px; font-weight:600;width: 3%;">NO</th>
                        <th style="font-size:10px; font-weight:600;width: 40%;">URAIAN</th>
                        <th style="font-size:10px; font-weight:600">MINGGU 1</th>
                        <th style="font-size:10px; font-weight:600">MINGGU 2</th>
                        <th style="font-size:10px; font-weight:600">MINGGU 3</th>
                        <th style="font-size:10px; font-weight:600">MINGGU 4</th>
                        <th style="font-size:10px; font-weight:600">MINGGU 5</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                    ...
                    foreach ($data_mingguan as $key => $value) {
                        ...
                        echo "<td style='font-size:10px; font-weight:600'>" . $function->getdata_td($value, 'minggu1') . "</td>";
                        echo "<td style='font-size:10px; font-weight:600'>" . $function->getdata_td($value, 'minggu2') . "</td>";
                        echo "<td style='font-size:10px; font-weight:600'>" . $function->getdata_td($value, 'minggu3') . "</td>";
                        echo "<td style='font-size:10px; font-weight:600'>" . $function->getdata_td($value, 'minggu4') . "</td>";
                        echo "<td style='font-size:10px; font-weight:600'>" . $function->getdata_td($value, 'minggu5') . "</td>";
                        echo "</tr>";
                    }
                    ?>
                </tbody>
